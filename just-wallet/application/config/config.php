...
|
*/
$config['base_url'] = 'https://wallet.test'; // SEE ENVIROMENT CONFIG FILES
...
$config['csrf_exclude_uris'] = array(
    'ajax/[a-z_]+', 'ipn/paypal', 'ipn/perfect_money', 'ipn/advcash', 'ipn/payeer', 'ipn/skrill', 'ipn/paygol', 'ipn/coinpayments', 'ipn/blockchain', 'sci/form', 'sci/start_payment', 'sci/test_mode'
);
