...
<head>
    ...
    <style>
        ...
        .sidebar-menu-profile .card {
            box-shadow: 0 1px 0 rgba(10, 10, 10, 0.1), 0 0 0 0 rgba(10, 10, 10, 0.1) !important;
        }

        .sidebar-menu-profile .card .card-content figure {
            margin: 0 auto;
        }

        .sidebar-menu-profile .card .card-content .content {
            text-align: center;
        }

        .sidebar-menu-profile .card .card-content {
            padding: 0.8rem;
        }
        ...
        .navbar-shadow {
            -webkit-box-shadow: 0 2px 3px rgba(10, 10, 10, 0.1), 0 0 0 0 rgba(10, 10, 10, 0.1);
...
<body>
<div class="columns">
    <div class="column is-2 has-background-white right-paddingless box-shadow">
        <aside class="menu">
    ...
    <div class="column is-10 left-paddingless">
        <section class="header is-info is-medium is-bold">
            <nav class="navbar is-transparent navbar-shadow">
        ...
        <section class="box cta is-shady">
            <p class="has-text-centered">
                <span class="tag is-primary">New</span> Ut enim ad minim veniam, quis nostrud exercitation ullamco
                laboris nisi
        ...
        <section class="container is-fluid">
            <div>
                            ...
                            <div class="card-content">
                                <div class="content">
                                    ...
                                    <p>Purus semper eget duis at tellus at urna condimentum mattis. Non blandit massa
                                        enim nec.
                                        Integer enim neque volutpat ac tincidunt vitae semper quis. Accumsan tortor
                                        posuere ac ut
                            ...
                            <div class="card-content">
                                <div class="content">
                                    ...
                                    <p>Ut venenatis tellus in metus vulputate. Amet consectetur adipiscing elit
                                        pellentesque. Sed
                                        arcu non odio euismod lacinia at quis risus. Faucibus turpis in eu mi bibendum
                                        neque egestas
                ...
                <div class="intro column is-8 is-offset-2">
                    ...
                    <p class="subtitle">Vel fringilla est ullamcorper eget nulla facilisi. Nulla facilisi nullam
                        vehicula ipsum a.
                            ...
                            <article class="tile is-child notification is-white">
                                ...
                                <div class="content">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna eros,
                                        eu
                                        pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus odio
                                        quis feugiat
                                        facilisis.</p>
                                </div>
                            </article>
                                ...
                                <article class="tile is-child notification is-white">
                                    ...
                                    <div class="content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin ornare magna
                                            eros, eu
                                            pellentesque tortor vestibulum ut. Maecenas non massa sem. Etiam finibus
                                            odio quis
                                            feugiat facilisis.</p>
                                    </div>
                                </article>
                                ...
                                <div class="content">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Integer sollicitudin, tortor a mattis commodo, velit urna rhoncus erat, vitae
                                            congue
                                            lectus dolor consequat libero. Donec leo ligula, maximus et pellentesque
                                            sed, gravida a
