...
$packets = $db -> query("SELECT * FROM packets WHERE item_id='{$id}'")->fetch();
echo '<div class="modal-dialog width-400px" role="document">
    <div class="modal-content">
        <div class="modal-header">
			...
			<input type="hidden" name="item_id_a_d_ads" value="'.$id.'">
			<p>'; if($users['picture'] != "") { 
            ...
            <div class="section-title">';
			  echo '<figure style="color:#979797;">Do you want to delete '.$packets['name'].' package order? <a style="padding:5px;" class="tran-s btn" type="submit" onclick="confirm_package_delete_ads()">Yes<i class="tran-s fa fa-thumbs-up"></i></a></figure>
            </div>';
	    echo '</form><br>
			<div id="confirm_package_delete_alert" style="display:none;" class="alert"></div>
        </div>
    </div>
</div>';