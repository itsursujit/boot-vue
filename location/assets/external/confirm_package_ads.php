...
echo '<div class="modal-dialog width-400px" role="document">
    <div class="modal-content">
        <div class="modal-header">
			...
			<input type="hidden" name="items_id_a_p_ads" value="'.$id.'">
			<p>'; if($users['picture'] != "") { 
            ...
            <div class="section-title">';
			  echo '<figure style="color:#979797;">Do you want to approve '.$packets['name'].' package?  <a style="padding:5px;" class="tran-s btn" type="submit" onclick="confirm_package_a_ads()">Yes<i class="tran-s fa fa-thumbs-up"></i></a></figure>
            </div>';
	    echo '</form><br>
