        ...
        <div class="modal-header">
		  ...
		  echo '<img style="width:24px;height:24px;border-radius:100%;" src="assets/img/profil/no-profile.png" alt="">'; 
            ...
            <section>
			 ...
			 <input type="hidden" name="users_ids_a" value="'.$users['id'].'">
              <p style="color:#757575;"><i class="fa fa-check-square-o"></i> Do you want to take back all the authority?</p>
				    <br>
				         <div class="form-group">
                                 <button type="submit" onclick="edit_admin_a()" class="btn btn-primary btn-rounded">Yes</button>
				         </div>
					     <div id="edit_admin_a_alert" style="display:none;" class="alert"></div>
		      </form>			 
                </div>
                </div>
            </section>
